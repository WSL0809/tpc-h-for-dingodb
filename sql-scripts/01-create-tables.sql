-- TPC-H Database Schema for MySQL
USE tpch_test;

-- Create tables with primary keys and indexes for better performance
CREATE TABLE NATION (
...
CREATE INDEX IDX_LINEITEM_SUPPLIER ON LINEITEM (L_SUPPKEY);
